...
function SelectText(value) {
    ...
    text.innerHTML = BelowStar.desc
            ...
            default:
                ...
                text.innerHTML = ' Hey!!! Si quieres una ventana modal, <a href="#Modal" class="OpenModal">clickeame</a> <br><br>   Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus quisquam labore cumque voluptas, nihil dignissimos laboriosam repellat voluptatibus consequuntur maxime placeat, eos suscipit voluptatum architecto possimus quos facere repellendus porro!'
                break;
    }
}
